...
KimChee_IMG = "https://telegra.ph/file/e7af7f0b6920b1769188d.jpg"
...
def send_start(bot, update):
    ...
    keyboard = [[
        InlineKeyboardButton(text=tld(chat.id, '🥳Updates Channel'),
                             url="https://t.me/KimCheeUpdates"), InlineKeyboardButton(text="❓ Help", callback_data="help_back")
        ]]
    keyboard += [[
        InlineKeyboardButton(text=tld(chat.id, '👥 Support Group'), url="https://t.me/KimCheeSupport")
    ]]
